...
void applicationLoop() {
	...
	while (psi) {
		...
		shaderMulLighting.setVectorFloat3("fogColor", glm::value_ptr(glm::vec3(1.0, 0.0, 1.0)));
		shaderMulLighting.setFloat("density",0.02);
		shaderMulLighting.setFloat("gradient", 1.0);

		shaderTerrain.setVectorFloat3("fogColor", glm::value_ptr(glm::vec3(1.0, 1.0, 0.0)));
		shaderTerrain.setFloat("density", 0.02);
		shaderTerrain.setFloat("gradient", 1.5);

		shaderSkybox.setVectorFloat3("fogColor", glm::value_ptr(glm::vec3(1.0, 1.0, 0.0)));
		shaderSkybox.setFloat("lowerLimit",0.05);
		shaderSkybox.setFloat("upperLimit",0.1);
		/*******************************************

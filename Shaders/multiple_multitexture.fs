...
vec3 calculateDirectionalLight(Light light, vec3 direction){
	...
	//queremos tomar el 70% del primer elemento y el 30% del seegundo
	//La funcuin mix solo recibe 3 elementos, los dos colores que deseamos convinar
	//y el grado al cual lo queremos hacer
	//Si desearamos unir mas de 2 colore tomariamos en color final y lo convinariamos de nuevo	

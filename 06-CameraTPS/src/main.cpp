...
std::shared_ptr<Camera> camera(new ThirdPersonCamera());//creacion de la camara en tercera persona
...
void init(int width, int height, std::string strTitle, bool bFullScreen) {
	...
	//Mayow
	mayowModelAnimate.loadModel("../models/Finn/Finn.fbx");
	mayowModelAnimate.setShader(&shaderMulLighting);


	//no tiene sentido configurar la posicion
...
bool processInput(bool continueApplication) {
	...
	if (glfwGetKey(window, GLFW_KEY_LEFT_CONTROL) == GLFW_PRESS && (window, GLFW_KEY_K) == GLFW_PRESS) {
